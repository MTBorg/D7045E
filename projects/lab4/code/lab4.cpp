  ...
  window->SetKeyPressFunction(
      [this](int32 keyCode, int32, int32 action, int32) {
        ...
        case GLFW_KEY_3:
          ...
          break;
        case GLFW_KEY_W:
          this->scene.objectsMovable[currentObject].translate(
              glm::vec3(0, 0, -movingDistance));
          break;
        case GLFW_KEY_A:
          this->scene.objectsMovable[currentObject].translate(
              glm::vec3(-movingDistance, 0, 0));
          break;
        case GLFW_KEY_S:
          this->scene.objectsMovable[currentObject].translate(
              glm::vec3(0, 0, movingDistance));
        ...
        case GLFW_KEY_Q:
          ...
          break;
        case GLFW_KEY_I:
          this->scene.objectsMovable[currentObject].rotate(-rotationAngle,
                                                           glm::vec3(1, 0, 0));
          break;
        case GLFW_KEY_J:
          this->scene.objectsMovable[currentObject].rotate(-rotationAngle,
